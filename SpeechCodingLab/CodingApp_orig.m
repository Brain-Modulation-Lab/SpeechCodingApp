...
% Last Modified by GUIDE v2.5 19-Jun-2018 19:09:10
...
uncodable=get(hObject,'Value');
         ...
         if uncodable>0
             ...
             CodingMat(13, RandList(trial))={'Uncodable'};
             setappdata(0,'CodingMat', CodingMat);
...
function other_type_Callback(hObject, eventdata, handles)
% hObject    handle to other_type (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% Hints: contents = cellstr(get(hObject,'String')) returns other_type contents as cell array
%        contents{get(hObject,'Value')} returns selected item from other_type

function other_type_CreateFcn(hObject, eventdata, handles)
% hObject    handle to other_type (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
